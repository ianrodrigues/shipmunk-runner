...
.PHONY: hooks hooks-check check lint package-check runner-check native-image-check go-check go-build go-runtime-check install-smoke-check install-smoke-host-check

check: hooks-check lint package-check runner-check native-image-check go-check go-runtime-check
